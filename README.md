...
This project was developed as part of the Bluestock Fintech Capstone Internship. The objective is to analyze mutual fund industry data, perform data cleaning, exploratory data analysis, compute performance metrics, and build an interactive Power BI dashboard to generate business insights.
...
- Equity funds attracted significant investor investments.
- Interactive Power BI dashboards enable efficient analysis of market trends.
